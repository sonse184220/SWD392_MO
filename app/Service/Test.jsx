...
const styles = StyleSheet.create({
  ...
  sidebar: { width: 220, backgroundColor: '#0D1117', padding: 20 },
  menuItem: { paddingVertical: 15, marginTop: 20 },
  menuText: { fontSize: 16, color: 'white' },
  dashboard: { flex: 1, padding: 20 },
  heading: { fontSize: 24, fontWeight: 'bold', marginBottom: 10, color: 'black', textAlign: "center" },
